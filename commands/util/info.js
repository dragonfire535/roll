...
const { ROLL_GITHUB_REPO_USERNAME, ROLL_GITHUB_REPO_NAME } = process.env;
const source = ROLL_GITHUB_REPO_NAME && ROLL_GITHUB_REPO_USERNAME;
	...
	run(msg) {
		const embed = new MessageEmbed()
			...
			.addField('❯ Source Code',
				source ? `[Here](https://github.com/${ROLL_GITHUB_REPO_USERNAME}/${ROLL_GITHUB_REPO_NAME})` : 'N/A', true)
